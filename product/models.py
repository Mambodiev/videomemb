...
class Product(models.Model):
    ...
    links_to_a_single_store = models.CharField(max_length=500, help_text = "A link that will take to the store", default='#')
    links_to_a_single_ads = models.CharField(max_length=500, help_text = "A link that will take to the store", default='#')
